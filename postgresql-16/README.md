# pg-precise-ddl for PostgreSQL 16

This directory installs the `ddl_original` extension into PostgreSQL 16.
...
This is a SQL-only extension package. This directory installs directly into `/usr/share/postgresql/16/extension` and does not require `pg_config`.
